...
from authlib.oauth2.stateful import (
    AuthorizationServerStateful as _AuthorizationServerStateful,
)
...
class AuthorizationServerStateful(_AuthorizationServerStateful):
    ...
    def __init__(self, app=None, query_client=None, save_token=None, wasm_engine=None, wasm_linker=None):
        super(AuthorizationServerStateful, self).__init__(wasm_engine=wasm_engine, wasm_linker=wasm_linker)
