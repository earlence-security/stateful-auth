from ..rfc6749.authenticate_client import ClientAuthentication
from ..rfc6749.requests import OAuth2Request, JsonRequest
...
class AuthorizationServerStateful(object):
    ...
    """
    def __init__(self, scopes_supported=None, wasm_engine=None, wasm_linker=None):
